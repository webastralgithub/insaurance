...
const KlientaleShareMe = ({ role }) => {
  ...
  const sendRefferal = async (contact) => {
    ...
    try {
      ...
      const response = await axios.post(`${klintaleUrl}share`,
        { sendTo: contact, selectedContacts: [id], type: 1, email: email.email }, {
        headers,
      });
  ...
  return (
    <div>
      ...
      <div className="add_property_btn">
        ...
        <div className="inner-pages-top inner-pages-top-share-ref" style={{ "paddingBottom": "34px" }}>
...
export default KlientaleShareMe;
