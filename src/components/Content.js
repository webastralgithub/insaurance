...
const clearErrors = (fieldName) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="form-user-add">
          ...
          <h3> <button  type="button" className="back-only-btn" onClick={goBack}> <img src="/back.svg" /></button>Add Content</h3>
          ...
          <label>Heading<span className="required-star">*</span></label>
          <input
            type="text"
            name="name"
            value={contact.name}
